...
class Juguete implements IParte1 , IParte2
{
    ...
    public function Modificar($tipo, $precio, $pais, $foto)
    {
        $retorno = false;
            
       
            $objetoDatos = AccesoDatos::DameUnObjetoAcceso();
            $consulta = $objetoDatos->RetornarConsulta('UPDATE juguetes SET tipo = :tipo, precio = :precio, pais = :pais, foto = :foto WHERE tipo = :tipoAct AND precio = :precioAct AND pais = :paisAct AND foto = :fotoAct');
